...
enum MenuEntry {
    ...
    colorRed('Dark Red Background', SingleActivator(LogicalKeyboardKey.keyR, control: true)),
    colorGreen('Dark Green Background', SingleActivator(LogicalKeyboardKey.keyG, control: true)),
    colorBlue('Dark Blue Background', SingleActivator(LogicalKeyboardKey.keyB, control: true));
