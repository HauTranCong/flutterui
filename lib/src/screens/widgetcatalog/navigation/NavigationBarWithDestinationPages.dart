...
class NavigationBarWithDestinationPages extends StatefulWidget {
  const NavigationBarWithDestinationPages({super.key});

  @override
  State<NavigationBarWithDestinationPages> createState() => _NavigationBarWithDestinationPagesState();
}

class _NavigationBarWithDestinationPagesState extends State<NavigationBarWithDestinationPages> with TickerProviderStateMixin<NavigationBarWithDestinationPages> {
